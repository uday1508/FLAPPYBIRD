...
import PipeTop from './characters/PipeTop';
    ...
    touches.filter(t => t.type === "press").forEach(t => {
        if (!hadTouches){
            if (world.gravity.y === 0.0){
                world.gravity.y = 0.5;
                addPipesAtLocation((Constants.MAX_WIDTH * 1.2) - (Constants.PIPE_WIDTH / 2), world, entities);
                addPipesAtLocation((Constants.MAX_WIDTH * 2.2) - (Constants.PIPE_WIDTH / 2), world, entities);
            }
